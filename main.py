...
if __name__ == "__main__":
    ...
    for i, items in enumerate(models):
        ...
        with mlflow.start_run(run_name = model_name):
            ...
            mlflow.log_metric("recall_class_0", report_lr["0"]["recall"])
            mlflow.log_metric("recall_class_1", report_lr["1"]["recall"])
            mlflow.log_metric("recall", report_lr["weighted avg"]["recall"])
            mlflow.log_metric("f1_class_0", report_lr["0"]["f1-score"])
            mlflow.log_metric("f1_class_1", report_lr["1"]["f1-score"])
            mlflow.log_metric("f1", report_lr["weighted avg"]["f1-score"])
